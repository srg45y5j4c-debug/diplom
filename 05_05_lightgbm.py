...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(
            os.path.join(DATA_DIR, "lightgbm.log"), encoding="utf-8"
        ),
...
pipeline_path = os.path.join(MODELS_DIR, "lightgbm_best.pkl")
joblib.dump(best_pipeline, pipeline_path)
log.info(f"   pipeline: {pipeline_path}")

imp_path = os.path.join(MODELS_DIR, "lightgbm_feature_importance.csv")
...
metrics_path = os.path.join(MODELS_DIR, "lightgbm_metrics.csv")
...
plt.tight_layout()
plot_path = os.path.join(MODELS_DIR, 'lightgbm_diagnostics.png')

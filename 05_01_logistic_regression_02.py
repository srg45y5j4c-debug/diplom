...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(
            os.path.join(DATA_DIR, f"logistic_regression{MODEL_SUFFIX}.log"), encoding="utf-8"
        ),
...
pipeline_path = os.path.join(MODELS_DIR, f"logistic_regression{MODEL_SUFFIX}_best.pkl")
joblib.dump(best_pipeline, pipeline_path)
log.info(f"   ✅ Pipeline: {pipeline_path}")

#coef_path = os.path.join(MODELS_DIR, "logistic_coefficients.csv")
coef_path = os.path.join(MODELS_DIR, f"logistic_coefficients{MODEL_SUFFIX}.csv")
...
metrics_path = os.path.join(MODELS_DIR, f"logistic_metrics{MODEL_SUFFIX}.csv")
...
plot_path = os.path.join(MODELS_DIR, f"logistic_regression_diagnostics{MODEL_SUFFIX}.png")
